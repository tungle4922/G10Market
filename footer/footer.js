...
<div class="grid wide">
<div class="row">
    <div class="col l-2-4 m-12 c-12" style="padding-left: 36px;">
        <img src="./assests/img/logo_test.png" alt="" class="footer__logo" />
        <ul class="footer__list">
            ...
            <li class="footer__list-item">
                ...
                <a href="mailto:marketg10@gmail.com?subject=Mail from our Website"
                    class="footer__list-item-tittle">marketg10@gmail.com</a>
            </li>
            <li class="footer__list-item">
                <i class="footer__list-item-icon fa-brands fa-telegram"></i>
                <a href="" class="footer__list-item-tittle">@g10support</a>
            </li>
        </ul>
    </div>

    <div class="col l-2-4 m-4 c-6" style="padding-left: 36px;">
        <h3 class="footer__heading">GIỚI THIỆU</h3>
        <ul class="footer__list">
            <li class="footer__list-item">
                <a href="./introduce.html" class="footer__list-item-tittle">Giới thiệu</a>
            </li>
            <li class="footer__list-item">
                <a href="./contact.html" class="footer__list-item-tittle">Liên hệ</a>
            </li>
            <li class="footer__list-item">
                <a href="./news.html" class="footer__list-item-tittle">Tin tức</a>
            </li>
            <li class="footer__list-item">
                <a href="./recruit.html" class="footer__list-item-tittle">Tuyển dụng</a>
            </li>
            <li class="footer__list-item">
                <a href="./policy.html" class="footer__list-item-tittle">Chính sách bảo mật</a>
            </li>
            <li class="footer__list-item">
                <a href="./paymentPolicy.html" class="footer__list-item-tittle">Chính sách thanh toán</a>
            </li>
        </ul>
    </div>
    ...
    <div class="col l-2-4 m-4 c-6" style="padding-left: 36px;">
        ...
        <ul class="footer__list">
            <li class="footer__list-item">
                <a href="./categoryProduct.html?raunhapkhau" class="footer__list-item-tittle">Rau nhập
                    khẩu</a>
            </li>
            <li class="footer__list-item">
                <a href="./categoryProduct.html?hoaquatuoi" class="footer__list-item-tittle">Hoa quả
                    tươi</a>
            </li>
            <li class="footer__list-item">
                <a href="./categoryProduct.html?traicaynhapkhau" class="footer__list-item-tittle">Trái cây
                    nhập khẩu</a>
            </li>
            <li class="footer__list-item">
                <a href="./categoryProduct.html?namcacloai" class="footer__list-item-tittle">Nấm các
                    loại</a>
            </li>
            <li class="footer__list-item">
                <a href="./categoryProduct.html?hoaquadalat" class="footer__list-item-tittle">Hoa quả Đà
                    Lạt</a>
            </li>
            <li class="footer__list-item">
                <a href="./categoryProduct.html?rautuoisach" class="footer__list-item-tittle">Rau tươi
                    sạch</a>
            </li>
        </ul>
    </div>
